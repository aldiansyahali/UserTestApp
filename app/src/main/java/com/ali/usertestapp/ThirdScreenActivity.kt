...
import com.ali.usertestapp.api.ApiService
import com.ali.usertestapp.data.ApiResponse
import com.ali.usertestapp.data.User
import com.ali.usertestapp.databinding.ActivityMainBinding
    ...
    private inner class UserViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(user: User) {
            ...
            itemView.setOnClickListener {
                val selectedUserName = findViewById<TextView>(R.id.tv_name)
